...
const log: Logger = winstonLogger(`${config.ELASTIC_SEARCH_URL}`, 'Chat Service Queue Producer', 'debug');
...
export async function publishDirectMessage(
    ...
    try {
        ...
        log.log('error', `❌ Chat Service publishDirectMessage() Method`, error);
    }
}
